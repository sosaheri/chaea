            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Paso 5 / 10</h4>
                </div>
              </div>
                  <!-- Session Status -->
              ...
              <div class="card-body">
                    <div class="question-wrap">
                        <label class="form-check-label" id="question1">33 Tiendo a ser perfeccionista.</label><br>
                    ...
                    <div class="question-wrap">
                        <label class="form-check-label" id="question2">34 Prefiero oír las opiniones de los demás antes de exponer la mía.</label><br>
                        <div class="form-check form-check-inline">
                    ...
                    <div class="question-wrap">
                        <label class="form-check-label" id="question3">35 Me gusta afrontar la vida espontáneamente y no tener que planificar todo previamente.</label><br>
                        <div class="form-check form-check-inline">
                    ...
                    <div class="question-wrap">
                        <label class="form-check-label" id="question4">36 En las discusiones me gusta observar cómo actúan los demás participantes.</label><br>
                        <div class="form-check form-check-inline">
                    ...
                    <div class="question-wrap">
                        <label class="form-check-label" id="question5">37 Me siento incómodo/a con las personas calladas y demasiado analíticas.</label><br>
                        <div class="form-check form-check-inline">
                    ...
                    <div class="question-wrap">
                        <label class="form-check-label" id="question6">38 Juzgo con frecuencia las ideas de los demás por su valor práctico.</label><br>
                        <div class="form-check form-check-inline">
                    ...
                    <div class="question-wrap">
                        <label class="form-check-label" id="question7">39 Me agobio si me obligan a acelerar mucho el trabajo para cumplir un plazo.</label><br>
                        <div class="form-check form-check-inline">
                    ...
                    <div class="question-wrap">
                        <label class="form-check-label" id="question8">40 En las reuniones apoyo las ideas prácticas y realistas.</label><br>
                        <div class="form-check form-check-inline">
                    ...
                    <a id="next-link" href="{{ route('step6') }}" style="background: #0D0E4C !important" class="btn text-center bg-gradient-primary w-100 my-4 mb-2" >Siguiente</a>
...
<script>
    ...
    nextLink.addEventListener('click', function(event) {
        ...
        let step5Data = {
            q33: document.querySelector('input[name="flexRadioDefault"]').checked ? 1 : 0,
            q34: document.querySelector('input[name="flexRadioDefault2"]').checked ? 1 : 0,
            q35: document.querySelector('input[name="flexRadioDefault3"]').checked ? 1 : 0,
            q36: document.querySelector('input[name="flexRadioDefault4"]').checked ? 1 : 0,
            q37: document.querySelector('input[name="flexRadioDefault5"]').checked ? 1 : 0,
            q38: document.querySelector('input[name="flexRadioDefault6"]').checked ? 1 : 0,
            q39: document.querySelector('input[name="flexRadioDefault7"]').checked ? 1 : 0,
            q40: document.querySelector('input[name="flexRadioDefault8"]').checked ? 1 : 0
        };

        sessionStorage.setItem('step5', JSON.stringify(step5Data));
